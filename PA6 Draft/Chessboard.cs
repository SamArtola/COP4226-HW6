...
namespace PA6_Draft
{
    public partial class Chessboard : Form
    {
        ...
        private SoundPlayer captured = new SoundPlayer(@"croc_chomp_x.wav");
        private SoundPlayer castled = new SoundPlayer(@"cymbals.wav");
        private SoundPlayer promoted = new SoundPlayer(@"chime_up.wav");
        private SoundPlayer stalemate = new SoundPlayer(@"boing_x.wav");
        private SoundPlayer timesup = new SoundPlayer(@"buzzer3_x.wav");
        ...
        internal Chessboard(Color Light, Color Dark, ChessGame Game)
        {
            ...
            this.Game = Game;
            Player1Time.DataBindings.Add("Text", Game, "WhiteTimeLimit", false,DataSourceUpdateMode.OnPropertyChanged);
            Player2Time.DataBindings.Add("Text", Game, "BlackTimeLimit", false, DataSourceUpdateMode.OnPropertyChanged);

            /*change 2: bind Game.WhiteTimeLimit to Player1Time.Text and
        ...
        private object Game_Moved(Move move)
        {
            ...
            if(move.CapturedPiece == Piece.NONE)//move
                ...
            else//capture
                ...
            */
        ...
        private object Game_Castled(Move move)
        {
            castled.Play();
